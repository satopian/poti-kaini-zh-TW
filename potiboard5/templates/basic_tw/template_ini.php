...
define('HONORIFIC_SUFFIX', '');//hogeさん, in Chinese?
...
define('MSG049', "被拒絕。");
define('MSG050', "Cookie 驗證失敗。");
define("MSG051", "由於密碼嘗試不正確而被鎖定。");
define("MSG052", "由於日誌檔案的檔案大小超過了限制值，因此處理已停止。");
define("MSG053", "請稍等一下。");
define("MSG054", "請啟用 JavaScript。");
